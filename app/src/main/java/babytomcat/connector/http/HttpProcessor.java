package babytomcat.connector.http;

import babytomcat.ServletProcessor;
import babytomcat.StaticResourceProcessor;
import babytomcat.util.RequestUtil;
import babytomcat.util.StringManager;
...
public class HttpProcessor {
  ...
  protected StringManager sm =
    StringManager.getManager("bundle");
